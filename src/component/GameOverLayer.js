...
comp.GameOverLayer = cc.LayerColor.extend(
{
	...
	_initMenu : function( )
	{
		var leaveButton		= new cc.MenuItemSprite( new cc.Sprite( res.leave_normal_png ) ,
													 new cc.Sprite( res.leave_selected_png ) ,
													 this._onLeaveCallback ,
													 this ) ;
		
		var tryAgainButton	= new cc.MenuItemSprite( new cc.Sprite( res.try_again_normal_png ) ,
													 new cc.Sprite( res.try_again_selected_png ) ,
